...
namespace STS
{
    ...
    public class RequestSecurityToken : RequestSecurityTokenBase
    {
        ...
        public RequestSecurityToken()
            : this(String.Empty, String.Empty, String.Empty, 0, Constants.Trust.KeyTypes.Symmetric, null, null, null)
        {
        }
        ...
        public RequestSecurityToken(string context, string tokenType, string requestType, int keySize, string keyType, SecurityToken proofKey, SecurityToken entropy, EndpointAddress appliesTo)
