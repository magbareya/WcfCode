...
<xsl:variable name="TitleLabel1">WSDL Validation Report</xsl:variable>
<xsl:variable name="TitleLabel2">WSDL Validation Report</xsl:variable>
<xsl:variable name="WSDLHierarchyLabel">WSDL Hierarchy</xsl:variable>
<xsl:variable name="ResultsLabel">Detailed Result</xsl:variable>
<xsl:variable name="SettingsLabel">Settings:</xsl:variable>
<xsl:variable name="FontLabel1"> - Failed</xsl:variable>
<xsl:variable name="FontLabel2"> - Failed</xsl:variable>
<xsl:variable name="FontLabel3"> - Failed</xsl:variable>
<xsl:variable name="FontLabel4"> - Warning</xsl:variable>
<xsl:variable name="FontLabel5"> - Passed</xsl:variable>
<xsl:variable name="MessageInformationTableLabel">Message Information table</xsl:variable>
<xsl:variable name="TableHeadLabel1">Line No.</xsl:variable>
<xsl:variable name="TableHeadLabel2">Position</xsl:variable>
<xsl:variable name="TableHeadLabel3">Message</xsl:variable>
